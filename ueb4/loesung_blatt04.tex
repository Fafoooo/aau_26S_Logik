...
\medskip
\textbf{Schritt 3: Constraints formulieren.}
F\"unf Bedingungen als Teilformeln; die Gesamtformel ist ihre
Konjunktion.

\smallskip
\textbf{(C1) Jedes Feld enth\"alt mindestens eine Ziffer:}
\[
C_1 \;\equiv\; \bigwedge_{i=1}^{4} \bigwedge_{j=1}^{4}
\bigl(x_{i,j,1} \vee x_{i,j,2} \vee x_{i,j,3} \vee x_{i,j,4}\bigr).
\]
16 Klauseln (eine pro Feld).

\smallskip
\textbf{(C2) Jedes Feld enth\"alt h\"ochstens eine Ziffer:}
\[
C_2 \;\equiv\; \bigwedge_{i=1}^{4} \bigwedge_{j=1}^{4}
\bigwedge_{1 \le n < m \le 4}
\neg\bigl(x_{i,j,n} \wedge x_{i,j,m}\bigr).
\]
$16 \cdot 6 = 96$ Klauseln.

\smallskip
\textbf{(C3) Keine Ziffer zweimal in derselben Zeile:}
\[
C_3 \;\equiv\; \bigwedge_{i=1}^{4} \bigwedge_{n=1}^{4}
...
\smallskip
\textbf{(C4) Keine Ziffer zweimal in derselben Spalte:}
\[
C_4 \;\equiv\; \bigwedge_{j=1}^{4} \bigwedge_{n=1}^{4}
...
\smallskip
\textbf{(C5) Keine Ziffer zweimal in derselben Region:}
\[
C_5 \;\equiv\; \bigwedge_{R \in \{R_1, R_2, R_3, R_4\}}
\bigwedge_{n=1}^{4}
\bigwedge_{\substack{(i,j),(k,l) \in R \\ (i,j) \neq (k,l)}}
...
\[
\Phi \;\equiv\; C_1 \wedge C_2 \wedge C_3 \wedge C_4 \wedge C_5.
\]
