...
F\"ur jede Zeile mit Ergebnis~\textbf{1} wird ein \textbf{Minterm}
gebildet: Variable mit Wert~1 bleibt positiv, Variable mit Wert~0
wird negiert. Alle Minterme werden mit $\vee$ verbunden.

Wahre Zeilen:
$(X,Y,Z) \in \{(0,0,0),\,(0,0,1),\,(0,1,0),\,(1,1,1)\}$.

\smallskip
Beispiel Zeile~$(0,0,0)$: $X\!=\!0 \to \neg X$,
$Y\!=\!0 \to \neg Y$, $Z\!=\!0 \to \neg Z$
$\;\Rightarrow\;$ Minterm $(\neg X \wedge \neg Y \wedge \neg Z)$.
...
F\"ur jede Zeile mit Ergebnis~\textbf{0} wird ein \textbf{Maxterm}
gebildet: hier werden die Literale \emph{umgedreht} -- Variable mit
Wert~1 wird negiert, Variable mit Wert~0 bleibt positiv.
Alle Maxterme werden mit $\wedge$ verbunden.

Falsche Zeilen:
$(X,Y,Z) \in \{(0,1,1),\,(1,0,0),\,(1,0,1),\,(1,1,0)\}$.

\smallskip
Beispiel Zeile~$(0,1,1)$: $X\!=\!0 \to X$,
$Y\!=\!1 \to \neg Y$, $Z\!=\!1 \to \neg Z$
$\;\Rightarrow\;$ Maxterm $(X \vee \neg Y \vee \neg Z)$.
